    ...
    <Container ref={introduceObserver}>
      ...
      >
        <AnimationWrapper variants={slideFontAnimation}>
          ...
          <HeadFont>
            프론트 엔드 개발자 정주형입니다. 서울에 거주하고 있습니다. 열심히
      ...
      >
        <AnimationWrapper variants={slideFontAnimation}>
          ...
          <MediumFont>
            잘 짜여진 코드 위에서 살아있는 공간을 만들고 싶습니다.
          </MediumFont>
          <Blank />
          <MediumFont>
      ...
      >
        <AnimationWrapper variants={slideFontAnimation}>
          ...
          <SecondFont>
            탐구 정신을 가진 개발자가 되고 싶습니다. 좀 더 효율적인 코드를 위해
            로우한 부분까지 파고드는 것을 좋아합니다. 잘 만든 웹 사이트들을
            들어갈때마다 어떻게 이루어져 있는지 관찰합니다.
          </SecondFont>
          <Blank />
          <SecondFont>
            UI와 UX가 기술적 요소만큼 중요하다고 생각하며 이를 위해 다양한
            분야의 경험을 하기 위해 노력하고 있습니다. 개발자를 하기 전 저의
            경력이 더 넓은 시야를 가지는데 도움을 줄 수 있을 거라고 생각합니다.
          </SecondFont>
        </AnimationWrapper>
      </Description>
    </Container>
