...
import { svgAnimation } from "../animations/variants";

const UnderLineAnimtion = ({ attachRef, controls }) => {
  return (
    <UnderLineSvg
      ref={attachRef}
      viewBox="0 0 572 225"
...
const ArrowAnimation = ({ attachRef, controls }) => {
  return (
    <ArrowSvg
      ref={attachRef}
      viewBox="0 0 726 164"
...
const Arrow2Animation = ({ attachRef, controls }) => {
  return (
    <Arrow2Svg
      ref={attachRef}
      viewBox="0 0 623 598"
...
export { UnderLineAnimtion, ArrowAnimation, Arrow2Animation };

const UnderLineSvg = styled(motion.svg)`
  position: absolute;
  left: 52%;
  top: 80%;
...
const Arrow2Svg = styled(motion.svg)`
  position: absolute;
  right: 15%;
  top: 0%;
